                        ...
                        <div class="card-body">
                            ...
                            if($edad>=18){
                               ...
                               echo ' <div class="row">
                                ...
                                echo '<div class="row">
                                        <div class="col-sm-1"><i class="far fa-file-pdf"></i></div><div class="col-sm-11"><a href="descargarword.php?f='.base64_encode('documentos_concursos/debate/autorizacion.docx').'" target="_blank">Autorización del uso de iamgen.</a></div>
                                      </div>';
                   ...
                   <div class="card">
                        ...
                        ////////////////////////////////////////////// 0
                         ...
                         ////////////////////////////////////////////// 1
                                ...
                                echo '<div class="row" id="row-1">
                                        ...
                                        <div class="col-sm">';
                                        if($comprobante){
                                            echo '<a href="getfilepdf.php?data='.$comprobante_64.'" target="_blank" class="btn btn-primary">Mi comprobante de domicilio</a>';
                                ...
                                echo   '</div>
                                        <div class="col-sm">
                                            ...
                                            <div class="upload-btn-wrapper" '.$validado_disabled2.'>
                                                <div class="btn-upload-custom"><i class="fas fa-upload"></i> Adjuntar comprobante de domicilio</div>
                        ...
                        ///////////////////////////////////////////// 2
                                ...
                                echo '<div class="row" id="row-2">
                                        ...
                                        <div class="col-sm">';
                                        if($aceptacion){
                                            echo '<a href="getfilepdf.php?data='.$aceptacion_64.'" target="_blank" class="btn btn-primary">Mi aceptación de...</a>';
                                ...
                                echo   '</div>
                                        <div class="col-sm">
                                            ...
                                            <div class="upload-btn-wrapper" '.$validado_disabled2.'>
                                                <div class="btn-upload-custom"><i class="fas fa-upload"></i> Adjuntar aceptación de los términos...</div>
                        ...
                        ///////////////////////////////////////////// 4
                                ...
                                echo '<div class="row" id="row-4">
                                        ...
                                        <div class="col-sm">';
                                        if($manifestacion){
                                            echo '<a href="getfilepdf.php?data='.$manifestacion_64.'" target="_blank" class="btn btn-primary">Mi manifestación...</a>';
                        ...
                        ///////////////////////////////////////////// 5
                                ...
                                echo '<div class="row" id="row-5">
                                        ...
                                        <div class="col-sm">';
                                        if($autorizacion){
                                            echo '<a href="getfilepdf.php?data='.$autorizacion_64.'" target="_blank" class="btn btn-primary">Mi autorización...</a>';
                                ...
                                echo   '</div>
                                        <div class="col-sm">
                                            ...
                                            <div class="upload-btn-wrapper" '.$validado_disabled2.'>
                                                <div class="btn-upload-custom"><i class="fas fa-upload"></i> Adjuntar autorización del uso de imagen.</div>
