<?php
header("Location: login.php"); ////no existe
...
/*
  ...
  if(!isset($_GET['concurso'])){
    ...
    $fecha1="2019-09-04 11:29:00"; ///2019-07-16
    $fecha2="2019-10-30 19:00:00";
...
<div class="container">
  ...
  <div class="col-md-5">
    ...
    <div class="m-5" ><a href="https://www.iecm.mx/concurso-vota-film-fest/" target="_blank">Consulta la convocatoria</a></div>
  </div>
                              ...
                              echo '<div class="row">';
                               ...
                               echo '<p>Menores de edad (12 a 17 años)</p>';                     
                                ...
                                echo ' <div class="row" >
                                        ...
                                        <div class="col-sm-11">
                                          <a href="descargarword.php?f='.base64_encode('documentos_descarga/1_carta-cesion-derechos-menor.pdf').'" target="_blank">1. Formato de declaracion de que la obra es original e inédita, así como la carta de cesión de derechos de la madre, padre o tutor</a>
                                        </div>
                                      </div>';
                                ...
                                echo ' <div class="row">
                                            ...
                                            <div class="col-sm-11">
                                              <a href="descargarword.php?f='.base64_encode('documentos_descarga/2_justificacion.pdf').'" target="_blank">2. Formato de justificación.</a>
                                            </div>
                                      </div>';
                                 echo '</div>'; //col-sm-6
                               ...
                               echo '<div class="col-sm-6">';
                                ...
                                echo ' <div class="row">
                                        ...
                                        <div class="col-sm-11">
                                          <a href="descargarword.php?f='.base64_encode('documentos_descarga/1_carta-cesion-derechos.pdf').'" target="_blank">1. Formato de declaracion de que la obra es original e inédita, así como la carta de cesión de derechos </a>
                                        </div>
                                      </div>';
                                ...
                                echo ' <div class="row">
                                            ...
                                            <div class="col-sm-11" ><a href="descargarword.php?f='.base64_encode('documentos_descarga/2_justificacion.pdf').'" target="_blank">2. Formato de justificación.</a>
                                            </div>
                                        </div>';
                                 ...
                                 echo '<div class="m-5" ><a href="https://www.iecm.mx/concurso-vota-film-fest/" target="_blank">Consulta la convocatoria</a></div>';
